...
<dl class="cart">
 ...
 <dd>
  <input type="checkbox"/>
  <a href="product.html" class="goodsPic"><img src="upload/goods004.jpg"/></a>
  <div class="goodsInfor">
   <h2>
    <a href="product.html">聚财貔貅风水摆件</a>
    <span>1</span>
   </h2>
   <div class="priceArea">
    <strong>0.00</strong>
 ...
 <dd>
  <input type="checkbox"/>
  <a href="product.html" class="goodsPic"><img src="upload/goods002.jpg"/></a>
  <div class="goodsInfor">
   <h2>
    <a href="product.html">烟灰缸 玻璃工艺品...</a>
    <span>1</span>
   </h2>
   <div class="priceArea">
    <strong>0.00</strong>
 ...
 <dd>
  <input type="checkbox"/>
  <a href="product.html" class="goodsPic"><img src="upload/goods003.jpg"/></a>
  <div class="goodsInfor">
   <h2>
    <a href="product.html">迷你花杯 送底座</a>
    <span>1</span>
   </h2>
   <div class="priceArea">
    <strong>0.00</strong>
...
<aside class="btmNav">
 <ul>
  ...
  <li><a>合计：￥0.00</a></li>
  <li><a href="confirm_order.html">立即下单</a></li>
 </ul>
</aside>
</body>
</html>
