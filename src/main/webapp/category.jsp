...
<div class="swiper-container category_list">
    <ul class="swiper-wrapper">
        <li class="swiper-slide"><a href="category.html">分类</a></li>
        <li class="swiper-slide"><a href="category.html">横向滚动</a></li>
        <li class="swiper-slide"><a href="category.html" class="curr_link">当前分类</a></li>
        <li class="swiper-slide"><a href="category.html">分类</a></li>
        <li class="swiper-slide"><a href="category.html">玻璃</a></li>
        <li class="swiper-slide"><a href="category.html">创意</a></li>
        <li class="swiper-slide"><a href="category.html">设计</a></li>
        <li class="swiper-slide"><a href="category.html">设计稿</a></li>
        <li class="swiper-slide"><a href="category.html">测试</a></li>
        <li class="swiper-slide"><a href="category.html">分类</a></li>
    </ul>
    <!-- Add Pagination -->
  ...
  <ul>
   <li>
    ...
    <div class="goodsInfor">
     <h2>
      <a href="product.html">水晶骷髅头 工艺品</a>
     </h2>
     <p>
      <del>5.90</del>
     </p>
   ...
   <li>
    ...
    <div class="goodsInfor">
     <h2>
      <a href="product.html">时尚烟灰缸 玻璃制品</a>
     </h2>
     <p>
      <del>12.90</del>
     </p>
   ...
   <li>
    ...
    <div class="goodsInfor">
     <h2>
      <a href="product.html">新婚天鹅 玻璃工艺品</a>
     </h2>
     <p>
      <del>9.90</del>
     </p>
